...
const pillars = [
  {
    ...
    description: 'Supporting female agripreneurs with tailored financing, training, and market access.',
  },
  {
    icon: Users,
    title: 'Youth mentorship',
    description: 'Preparing the next generation of agritech leaders through career coaching and internships.',
  },
  {
    icon: Sprout,
    title: 'Sustainable farming',
    description: 'Championing regenerative rice production and climate-smart practices across partner farms.',
  },
];
...
const sdgAlignment = [
  {
    ...
    description: 'Income diversification, savings groups, and reliable off-take contracts increase household resilience.',
  },
  {
    goal: 'SDG 4 · Quality Education',
    description: 'Literacy clinics and digital learning create pathways for youth to thrive in modern agriculture.',
  },
  {
    goal: 'SDG 5 · Gender Equality',
    description: 'Women-led agribusiness mentorship and leadership incubators accelerate equitable growth.',
  },
  {
    goal: 'SDG 12 · Responsible Consumption & Production',
    description: 'Regenerative farming practices and traceable supply chains protect Ghana’s natural resources.',
  },
];
    ...
    <div className="space-y-20 pb-20">
      <section className="relative overflow-hidden">
        <div className="absolute inset-0" aria-hidden="true">
          <Image src="/pics/IMG-20250315-WA0026.jpg" alt="Kyidom community impact" fill className="object-cover" priority />
        ...
        <div className="relative container grid gap-10 px-4 py-24 lg:grid-cols-[1.1fr,0.9fr] text-white">
          <div>
            ...
            >
              Kyidom Foods invests in women, youth, and farming households through programmes that combine agronomy, education, and entrepreneurship.
            </motion.p>
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              {impactStats.map((stat) => (
                <div key={stat.label} className="rounded-2xl bg-white/10 p-4 text-center">
                  <p className="text-2xl font-semibold text-gold-300">{stat.value}</p>
      ...
      <section className="container px-4">
        <h2 className="section-title text-center">What impact means to Kyidom</h2>
        <p className="section-subtitle mx-auto mt-4 max-w-3xl text-center">
          Beyond premium rice, we nurture resilient livelihoods, elevate literacy, and cultivate a thriving agrifood ecosystem.
        </p>
      ...
      {stories.map((story, index) => (
        <section key={story.title} className={`${index % 2 === 1 ? 'bg-amber-50' : 'bg-white'} py-16`}>
          <div className="container grid gap-10 px-4 lg:grid-cols-[1fr,1fr] lg:items-center">
            <div className={`${index % 2 === 1 ? 'lg:order-2' : ''} card-surface p-8`}
            >
              <span className="text-xs font-semibold uppercase tracking-wide text-gold-600">{story.subtitle}</span>
              <h3 className="mt-3 text-2xl font-semibold text-brown-900">{story.title}</h3>
              <p className="mt-4 text-sm text-brown-600">{story.description}</p>
            ...
            <div className={`${index % 2 === 1 ? 'lg:order-1' : ''} relative min-h-[320px] overflow-hidden rounded-3xl`}
            >
      ...
      <section className="container grid gap-10 px-4 py-16 lg:grid-cols-[1fr,0.9fr]">
        <div className="space-y-6">
          <h2 className="section-title text-white">Community mobilisation</h2>
          <p className="section-subtitle">
            From farmer co-ops to urban markets, we partner with grassroots leaders to expand access to agritech, finance, and nutrition.
          </p>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-white/15 bg-white/10 p-5 text-sm text-white/80">
              ...
              <p className="mt-2">Local centres providing soil testing, input access, and regenerative farming guidance.</p>
            </div>
            <div className="rounded-2xl border border-white/15 bg-white/10 p-5 text-sm text-white/80">
              <p className="font-semibold text-white">Youth leadership labs</p>
              <p className="mt-2">Mentorship programmes helping students explore agribusiness, STEM, and entrepreneurship.</p>
            </div>
          </div>
        </div>
        <div className="card-surface relative min-h-[360px] overflow-hidden">
          <Image src="/pics/IMG-20250315-WA0035.jpg" alt="Kyidom community" fill className="object-cover" />
      ...
      <section className="container px-4">
        ...
        <p className="section-subtitle mx-auto mt-4 max-w-3xl text-center">
          Real stories from farmers, students, and families whose livelihoods have transformed alongside Kyidom Foods.
        </p>
        <div className="mt-6 space-y-5 text-sm text-brown-600">
          <blockquote className="rounded-3xl bg-amber-50/80 p-5">
            “With Kyidom’s mechanisation support, I doubled my harvest and created jobs for other mothers in our cooperative.”
            <footer className="mt-3 text-xs font-semibold text-brown-900">Ama Owusu · Farmer, Central Region</footer>
          </blockquote>
          <blockquote className="rounded-3xl bg-amber-50/80 p-5">
            “The reading labs sparked my daughter’s interest in science. She now dreams of designing smart irrigation systems.”
            <footer className="mt-3 text-xs font-semibold text-brown-900">Kojo Mensah · Parent, Eastern Region</footer>
          </blockquote>
        </div>
      </section>
      ...
      <section className="container grid gap-10 px-4 py-16 lg:grid-cols-[1fr,0.9fr]">
        ...
        <div className="card-surface relative min-h-[360px] overflow-hidden">
          <Image src="/pics/IMG-20250315-WA0026.jpg" alt="Kyidom community engagement" fill className="object-cover" />
          <div className="absolute inset-0 bg-brown-900/20" />
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-brown-900/80 via-transparent to-transparent p-6 text-white">
            <p className="text-sm text-white/80">
              “Community impact is woven into every bag of Kyidom rice—from the seeds we plant to the futures we nourish.”
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-brown-900 py-16 text-white">
        <div className="container px-4 text-center">
          <h2 className="section-title text-white">Partner with Kyidom for impact</h2>
          <p className="mx-auto mt-4 max-w-3xl text-white/80">
            Join our partners, donors, and volunteers who power literacy, entrepreneurship, and resilient agriculture across Ghana.
          </p>
          <Link
            href="/contact"
